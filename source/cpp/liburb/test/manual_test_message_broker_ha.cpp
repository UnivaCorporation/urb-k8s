...
protected:  // You should make the members protected s.t. they can be
    ...
    void initializeLogging() {
        if (! loggingInitialized) {
            os::system("rm -rf /tmp/test_message_broker_ha");
            os::system("mkdir /tmp/test_message_broker_ha");
            FLAGS_log_dir = "/tmp/test_message_broker_ha";
            google::InitGoogleLogging("test_message_broker_ha");
    ...
    virtual void SetUp() {
        // Initialize logging
        initializeLogging();
        url = "urb://ha://head.private/mymaster";
    ...
    ~MessageBrokerTest() {
        os::system("chmod -R a+w /tmp/test_message_broker_ha");      
    }
